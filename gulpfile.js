...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new raspilc name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/raspilc.png')) {
        fs.renameSync(__dirname + '/admin/raspilc.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/raspilc.html')) {
        fs.renameSync(__dirname + '/widgets/raspilc.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/raspilc/js/raspilc.js')) {
        fs.renameSync(__dirname + '/widgets/raspilc/js/raspilc.js', __dirname + '/widgets/raspilc/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/raspilc')) {
        fs.renameSync(__dirname + '/widgets/raspilc',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /raspilc/g,
        ...
        {
            match: /Raspilc/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Raspilc'
        },
        {
            match: /Ivo Lohs/g,
            replacement: author
